...
struct ContentView: View {
    ...
    var sampleData = [Hospital(name: "Surrey Memorial Hospital", address: "13750 96 Ave, Surrey, BC V3V 1Z2", status: true, latitude: 49.176390, longitude: -122.842517, waitTime: "4:41", lengthOfStay: "5:18"),
